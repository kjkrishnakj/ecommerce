            ...
            <header className="body-font fixed w-full z-10">
                <div className="text-gray-600 mx-auto flex flex-wrap flex-col md:flex-row items-center shadow-xl sticky top-0 bg-white z-10">
                    <Link href="/" className="flex title-font p-1 font-medium items-center text-gray-900 mb-4 md:mb-0">
                        <Image src={logo} alt="logo" style={{ height: "4rem", width: "6rem" }} />
                    ...
                    <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
                        ...
                        <Link href="/about" className="mr-10 hover:text-gray-900">About</Link>
                        <Link href="/contact" className="mr-10 hover:text-gray-900">Contact</Link>
                        <Link href="/orders" className="mr-10 hover:text-gray-900">Orders</Link>
                    </nav>
                    ...
                    <div className="flex">
                        <Link href="/checkout">
                            <button disabled={disable} className="text-white disabled:bg-indigo-400 flex mx-2 bg-indigo-600 border-0 py-2 px-3 focus:outline-none hover:bg-indigo-700 mt-4 rounded text-lg">
                                <span><i className="fa-solid fa-bag-shopping mr-3"></i></span>Checkout
                            </button>
                        </Link>
