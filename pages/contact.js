...
const Contact = () => {
  ...
  const submit = () => {
    toast.success("Thanks  htmlFor your Feedback", { autoClose: 1000 })
    router.push("/")
  }
  return (
    ...
    <>
      <div className='min-h-screen text-gray-700 ' style={{ fontSize: "0.45cm" }}>
        <Head><title>Amikart | Contact</title></Head>
        <ToastContainer />
          ...
          <section className="bg-white ">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
              ...
              <form action="#" className="space-y-8">
                ...
                <button type="submit" onClick={submit} className="mt-4 mb-8 w-full disabled:bg-indigo-400  bg-indigo-600 border-0 rounded-md hover:bg-indigo-700 px-6 py-3 font-medium text-white">Send message</button>
              </form>
            </div>
          </section>
        </div>
