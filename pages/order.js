        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="w-full mx-auto flex flex-wrap">
            <div className=" w-full  lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              ...
              <p className="leading-relaxed text-green-600 mb-4">
                Yay! Your order has been succesfully placed.
              </p>
              <p className="leading-relaxed text-green-600 mb-4">
                {" "}
                Your Payment status : Payment {order.status}{" "}
              </p>
              ...
              {Object.keys(products).map((key) => (
                ...
                >
                  <p className=" text-gray-500" style={{ width: "7cm" }}>
                    {products[key].name} ({products[key].variant})
                  </p>
                  <p className="ml-auto px-7 text-gray-500">
                    {products[key].qty}
                  </p>
                  <p className="ml-auto px-7 text-gray-500">
                  ...
                  <p className="ml-auto  mb-4 h-24 w-28 rounded-md  object-cover object-center ">
