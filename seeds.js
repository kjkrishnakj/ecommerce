...
const productFilePath = path.join(__dirname, "amikart.products.json");
...
const userFilePath = path.join(__dirname, "amikart.users.json"); // Assuming users JSON is in this file
...
const seedDatabase = async () => {
  try {
    // Seed products
    await Product.deleteMany({}); // Remove existing documents
    await Product.insertMany(productsData); // Insert new documents
